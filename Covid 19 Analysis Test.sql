...
-- 4.) show the percentage of population that got covid in descending by Percentage with Covid
...
-- 3.) looking at countries with highest infection rate compared to population (Tableau Display)
...
-- 1.) GLOBAL Numbers (Tableau Display)
...
-- 2.) Continent with their total Death Count (Tableau Display)
...
-- showing the Locations with the highest death counts in Decending order.
